      ...
      <div class="header-right flx-align">
        <div class="header-right__inner gap-sm-3 gap-2 flx-align d-flex">
          ...
          <div class="theme-switch-wrapper position-relative">
            <label class="theme-switch" for="checkbox">
              ...
              <span class="slider text-black header-right__button white-version">
                <img src="/public/assets/dp-market-dashboard/images/icons/sun.svg" />
              </span>
              <span class="slider text-black header-right__button dark-version">
                <img src="/public/assets/dp-market-dashboard/images/icons/moon.svg" />
              </span>
            </label>
          </div>
          ...
          <div class="user-profile">
            <button class="user-profile__button flex-align">
              <span class="user-profile__thumb">
                <img src="/public/assets/dp-market-dashboard/images/thumbs/user-profile.png" class="cover-img" alt="User" />
              </span>
            </button>
          ...
          <div class="language-select flx-align select-has-icon">
            <img src="/public/assets/dp-market-dashboard/images/icons/globe.svg" class="globe-icon white-version" />
            <img src="/public/assets/dp-market-dashboard/images/icons/globe-white.svg" class="globe-icon dark-version" />
