        ...
        <div class="col-xxl-8">
          <div class="row gy-4">
            <div
              ...
              :data-aos-duration="product.duration"
            >
              <div
              ...
              >
                <div>
                  <span class="product-card__badge bg-danger-600 px-8 py-4 text-sm text-white"
                    >Sale 50%</span
                  >
                  <a :href="product.link" class="product-card__thumb flex-center overflow-hidden">
                ...
                <div class="product-card__content">
                  ...
                  <h6 class="title text-lg fw-semibold mt-12 mb-8">
                    <a :href="product.link" class="link text-line-2">{{ product.name }}</a>
                  </h6>
                  ...
                  <div class="mt-12">
                    ...
                    <span class="text-gray-900 text-xs fw-medium mt-8 d-block">Sold: 18/35</span>
                  </div>
                  <a
                    href="cart.html"
...
<script>
import bestSell1 from '@/assets/images/thumbs/best-sell1.png'
import bestSell2 from '@/assets/images/thumbs/best-sell2.png'
import bestSell3 from '@/assets/images/thumbs/best-sell3.png'
import bestSell4 from '@/assets/images/thumbs/best-sell4.png'
