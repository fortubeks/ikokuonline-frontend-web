        ...
        <div class="card-body">
          <div class="row gy-3">
            <div class="col-sm-6 col-xs-6">
              <label for="Vehicle Listing_category_id" class="form-label"
                >Vehicle Listing Category</label
              >
              <select
                id="Vehicle Listing_category_id"
            ...
            <div class="col-sm-12 text-end">
              <button class="btn btn-main btn-lg pill mt-4">
                {{ vehicleListing ? 'Update Vehicle Listing ' : 'Add Vehicle Listing' }}
              </button>
            </div>
          </div>
