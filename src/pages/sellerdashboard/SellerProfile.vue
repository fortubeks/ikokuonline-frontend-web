    ...
    <div class="avatar-upload">
      <div class="avatar-edit">
        ...
        <label for="imageUploadTwo">
          <span class="icon">
            <img src="@/assets/dp-market-dashboard/images/icons/camera-two.svg" alt="" />
          </span>
              ...
              <div class="avatar-upload mb-24">
                <div class="avatar-edit">
                  ...
                  <label for="imageUpload">
                    <img src="@/assets/dp-market-dashboard/images/icons/camera.svg" alt="" />
                  </label>
                </div>
                <div class="avatar-preview">
            ...
            <ul class="profile-info-list">
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon1.svg"
                    alt=""
                    class="icon"
                  />
              ...
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon2.svg"
                    alt=""
                    class="icon"
                  />
              ...
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon3.svg"
                    alt=""
                    class="icon"
                  />
              ...
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon4.svg"
                    alt=""
                    class="icon"
                  />
              ...
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon5.svg"
                    alt=""
                    class="icon"
                  />
              ...
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon6.svg"
                    alt=""
                    class="icon"
                  />
              ...
              <li class="profile-info-list__item">
                <span class="profile-info-list__content flx-align flex-nowrap gap-2">
                  <img
                    src="@/assets/dp-market-dashboard/images/icons/profile-info-icon7.svg"
                    alt=""
                    class="icon"
                  />
            ...
            <div class="dashboard-card__header pb-0">
              <ul class="nav tab-bordered nav-pills" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link font-18 font-heading active"
                ...
                <!-- <li class="nav-item" role="presentation">
                  <button
                    class="nav-link font-18 font-heading"
                ...
                >
                  <form action="#" autocomplete="off">
                    <div class="row gy-4">
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="phonee" class="form-label mb-2 font-18 font-heading fw-600"
                          >Phone Number</label
                        >
                        <input
                          type="tel"
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="emailAdddd" class="form-label mb-2 font-18 font-heading fw-600"
                          >Email Address</label
                        >
                        <input
                          type="email"
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="cityyy" class="form-label mb-2 font-18 font-heading fw-600"
                          >City</label
                        >
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="Stateee" class="form-label mb-2 font-18 font-heading fw-600"
                          >State/Region</label
                        >
                        <div class="select-has-icon">
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="Postcodeee" class="form-label mb-2 font-18 font-heading fw-600"
                          >Postcode</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="Countryyy" class="form-label mb-2 font-18 font-heading fw-600"
                          >Country</label
                        >
                        <div class="select-has-icon">
                ...
                >
                  <form action="#" autocomplete="off">
                    <div class="row gy-4">
                      ...
                      <div class="col-sm-6 col-xs-6">
                        <label for="emailAdd" class="form-label mb-2 font-18 font-heading fw-600"
                          >Email Address</label
                        >
                        <input
                          type="email"
                      ...
                      <div class="col-sm-12 text-end">
                        <button class="btn btn-main btn-lg pill mt-4">Pay Now</button>
                      </div>
                    </div>
                  </form>
                </div>
                    ...
                    <div class="row gy-4">
                      <div class="col-12">
                        ...
                        <div class="position-relative">
                          ...
                          <span class="input-icon input-icon--left"
                            ><img
                              src="@/assets/dp-market-dashboard/images/icons/key-icon.svg"
                              alt=""
                          /></span>
                          <span
                      ...
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <div class="position-relative">
                          ...
                          <span class="input-icon input-icon--left"
                            ><img
                              src="@/assets/dp-market-dashboard/images/icons/lock-two.svg"
                              alt=""
                          /></span>
                          <span
                            class="input-icon password-show-hide fas fa-eye la-eye-slash toggle-password-two"
